...
public class GuiBasicGreenhouse extends GuiContainer {
	...
	public static final ResourceLocation bground = new ResourceLocation(
			"Calculator:textures/gui/basicgreenhouse.png");

	public TileEntityBasicGreenhouse entity;

	public GuiBasicGreenhouse(InventoryPlayer inventoryPlayer,
	...
	protected void drawGuiContainerBackgroundLayer(float var1, int var2,
		...
		if (entity.slots[0] == null) {
			itemRender.renderItemIntoGUI(this.fontRendererObj,
					this.mc.getTextureManager(), new ItemStack(Blocks.log),
					this.guiLeft + 19, this.guiTop + 28);
		}
		if (entity.slots[1] == null) {
			itemRender.renderItemIntoGUI(this.fontRendererObj, this.mc
					.getTextureManager(), new ItemStack(Blocks.oak_stairs),
					this.guiLeft + 37, this.guiTop + 28);
		}
		if (entity.slots[2] == null) {
			itemRender.renderItemIntoGUI(this.fontRendererObj,

			this.mc.getTextureManager(), new ItemStack(Blocks.glass),
					this.guiLeft + 19, this.guiTop + 46);
		}
		if (entity.slots[3] == null) {
			itemRender.renderItemIntoGUI(this.fontRendererObj,
					this.mc.getTextureManager(),
					new ItemStack(Blocks.planks), this.guiLeft + 37,
					this.guiTop + 46);
		}
	}
}
