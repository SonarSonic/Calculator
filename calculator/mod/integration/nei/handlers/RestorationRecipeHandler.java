...
import sonar.calculator.mod.integration.nei.handlers.ExtractionRecipeHandler.SmeltingPair;
import codechicken.nei.NEIServerUtils;
import codechicken.nei.PositionedStack;
import codechicken.nei.recipe.TemplateRecipeHandler;

public class RestorationRecipeHandler
  extends TemplateRecipeHandler
{
    ...
    extends TemplateRecipeHandler.CachedRecipe
  {
	...
	public List<PositionedStack> getIngredients() {
      return getCycledIngredients(RestorationRecipeHandler.this.cycleticks / 48, Arrays.asList(new PositionedStack[] { this.input }));
    }
...
public void loadTransferRects()
  {
    this.transferRects.add(new TemplateRecipeHandler.RecipeTransferRect(new Rectangle(66, 19, 24, 10), "restoration", new Object[0]));
	...
	public String getRecipeName() {
		return StatCollector
				.translateToLocal("tile.RestorationChamber.name");
	}

	@Override
	public void loadCraftingRecipes(String outputId, Object... results) {
		if ((outputId.equals("restoration"))	&& (getClass() == RestorationRecipeHandler.class)) {
	...
	public void loadUsageRecipes(String inputId, Object... ingredients) {
		if ((inputId.equals("restoration"))&& (getClass() == RestorationRecipeHandler.class)) {
