...
public class TerrainModule extends BaseTerrainModule {
	...
	public TerrainModule() {
		...
		capacity = CalculatorConfig.terrainEnergy;
		maxReceive = CalculatorConfig.terrainEnergy;
		maxExtract = CalculatorConfig.terrainEnergy;
		maxTransfer = CalculatorConfig.terrainEnergy;
	}
}
