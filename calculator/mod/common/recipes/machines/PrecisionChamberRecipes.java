...
public class PrecisionChamberRecipes extends RecipeHelper {
	...
	public void addRecipes() {
		...
		addRecipe("cobblestone", new ItemStack(Calculator.small_stone, 2), new ItemStack(Calculator.circuitDamaged, 1, 1));
	    ...
	    addRecipe(Blocks.dirt, new ItemStack(Calculator.soil, 2), new ItemStack(Calculator.circuitDirty, 1, 7));     
