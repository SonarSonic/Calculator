...
public class ContainerRedstoneExtractor extends ContainerSync {

	private TileEntityGenerator.RedstoneExtractor entity;

	public ContainerRedstoneExtractor(InventoryPlayer inventory,
	...
	public ItemStack transferStackInSlot(EntityPlayer p_82846_1_, int p_82846_2_) {
		...
		if ((slot != null) && (slot.getHasStack())) {
			...
			if ((p_82846_2_ != 1) && (p_82846_2_ != 0)) {
				...
				} else if (RedstoneExtractorRecipes.discharge().value(
						itemstack1) > 0) {
