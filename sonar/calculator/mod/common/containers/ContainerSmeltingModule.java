...
public class ContainerSmeltingModule extends ContainerCraftInventory {
    ...
    public void addCraftingToCrafters(ICrafting icrafting)
    {
		...
		icrafting.sendProgressBarUpdate(this, 200,
				this.module.getEnergyStored(item));
		icrafting.sendProgressBarUpdate(this, 201,
				this.module.getEnergyStored(item) >> 16);
    }
    ...
    @SideOnly(Side.CLIENT)
      public void updateProgressBar(int slot, int value) {
        ...
        if (slot == 200) this.currentEnergy = DischargeValues.upcastShort(value);
        
        if (slot == 201) this.module.syncEnergy=this.currentEnergy | value << 16;
      }
