...
public class ContainerGlowstoneExtractor extends ContainerSync{
	
private TileEntityGenerator.GlowstoneExtractor entity;

public ContainerGlowstoneExtractor(InventoryPlayer inventory,
...
public ItemStack transferStackInSlot(EntityPlayer p_82846_1_, int p_82846_2_) {
	...
	if ((slot != null) && (slot.getHasStack())) {
		...
		if ((p_82846_2_ != 1) && (p_82846_2_ != 0)) {
			...
			} else if (GlowstoneExtractorRecipes.discharge().value(itemstack1) > 0) {
