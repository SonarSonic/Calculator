		...
		if (tileentity.getWorldObj() != null) {
			...
			if (chamber.slots[0] != null) {
				if (GameRegistry.findUniqueIdentifierFor(chamber.slots[0].getItem()).modId.equals(Calculator.modid)
						&& !RenderBlocks.renderItemIn3d(Block.getBlockFromItem(chamber.slots[0].getItem()).getRenderType()) && chamber.slots[0].getItem() instanceof ItemBlock
						&& Block.getBlockFromItem(chamber.slots[0].getItem()).getRenderType() == -1 && MinecraftForgeClient.getItemRenderer(chamber.slots[0], ItemRenderType.FIRST_PERSON_MAP) != null) {
					...
					if (Block.getBlockFromItem(chamber.slots[0].getItem()) == Calculator.starchextractor || Block.getBlockFromItem(chamber.slots[0].getItem()) == Calculator.glowstoneextractor
					...
					MinecraftForgeClient.getItemRenderer(chamber.slots[0], ItemRenderType.FIRST_PERSON_MAP).renderItem(ItemRenderType.FIRST_PERSON_MAP, chamber.slots[0], renderBlocks,
							new EntityItem(tileentity.getWorldObj(), (int) xCoord, (int) yCoord, (int) zCoord, chamber.slots[0]));
					;

				} else {
					GL11.glTranslated(0.0, 1.01, -0.06);
					GL11.glRotated(180, 1, 0, 0);
					if (!(chamber.slots[0].getItemSpriteNumber() == 0) || chamber.slots[0].getItemSpriteNumber() == 0 && chamber.slots[0].getItem() instanceof ItemBlock
