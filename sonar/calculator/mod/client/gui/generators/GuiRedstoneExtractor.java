...
public class GuiRedstoneExtractor extends GuiContainer {
	public static final ResourceLocation bground = new ResourceLocation("Calculator:textures/gui/redstonegenerator.png");

	public TileEntityGenerator.RedstoneExtractor entity;

	public GuiRedstoneExtractor(InventoryPlayer inventoryPlayer, TileEntityGenerator.RedstoneExtractor entity) {
		super(new ContainerRedstoneExtractor(inventoryPlayer, entity));
