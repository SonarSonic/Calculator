...
public class ProcessingRecipeHandler
  extends TemplateRecipeHandler
{
    ...
    extends TemplateRecipeHandler.CachedRecipe
  {
	...
	public List<PositionedStack> getIngredients() {
      return getCycledIngredients(ProcessingRecipeHandler.this.cycleticks / 48, Arrays.asList(new PositionedStack[] { this.input }));
    }
...
public void loadTransferRects()
  {
    this.transferRects.add(new TemplateRecipeHandler.RecipeTransferRect(new Rectangle(66, 19, 24, 10), "processing", new Object[0]));
	...
	public String getRecipeName() {
		return StatCollector
				.translateToLocal("tile.ProcessingChamber.name");
	}


	@Override
	public void loadCraftingRecipes(String outputId, Object... results) {
		if ((outputId.equals("processing"))	&& (getClass() == ProcessingRecipeHandler.class)) {
			Map<Object[], Object[]> recipes = ProcessingChamberRecipes.instance().getRecipes();
	...
	public void loadCraftingRecipes(ItemStack result) {
		Map<Object[], Object[]> recipes = ProcessingChamberRecipes.instance().getRecipes();
		for (Map.Entry<Object[], Object[]> recipe : recipes.entrySet()) {
			int pos = ProcessingChamberRecipes.instance().containsStack(result,	recipe.getValue(), false);
			if (pos != -1) {
				this.arecipes.add(new SmeltingPair(recipe.getKey()[0], recipe.getValue()[0]));
			}
		}
	...
	public void loadUsageRecipes(String inputId, Object... ingredients) {
		if ((inputId.equals("processing"))&& (getClass() == ProcessingRecipeHandler.class)) {
			loadCraftingRecipes("processing", new Object[0]);
		} else {
	...
	public void loadUsageRecipes(ItemStack ingredient) {
		Map<Object[], Object[]> recipes = ProcessingChamberRecipes.instance().getRecipes();
		for (Map.Entry<Object[], Object[]> recipe : recipes.entrySet()) {
			int pos = ProcessingChamberRecipes.instance().containsStack(ingredient, recipe.getKey(), false);
			if (pos != -1) {
				this.arecipes.add(new SmeltingPair(recipe.getKey()[0], recipe.getValue()[0]));
			}
		}
