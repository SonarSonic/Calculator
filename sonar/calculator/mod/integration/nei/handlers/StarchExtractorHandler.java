...
public class StarchExtractorHandler extends TemplateRecipeHandler {
	...
	public void loadTransferRects() {
		...
		this.transferRects.add(new TemplateRecipeHandler.RecipeTransferRect(new Rectangle(30 - 5, 17 - 11, 78, 10), "starch", new Object[0]));

	}

	@Override
	public void loadCraftingRecipes(String outputId, Object... results) {
		if ((outputId.equals("starch")) && (getClass() == StarchExtractorHandler.class)) {
			Map<ItemStack, Integer> recipes = StarchExtractorRecipes.discharge().getPowerList();
