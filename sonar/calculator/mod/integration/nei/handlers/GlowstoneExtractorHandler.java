...
public class GlowstoneExtractorHandler extends TemplateRecipeHandler {
	...
	public void loadTransferRects() {
		...
		this.transferRects.add(new TemplateRecipeHandler.RecipeTransferRect(new Rectangle(30 - 5, 17 - 11, 78, 10), "glowstone", new Object[0]));
	...
	public void loadCraftingRecipes(String outputId, Object... results) {
		if ((outputId.equals("glowstone")) && (getClass() == GlowstoneExtractorHandler.class)) {
			Map<ItemStack, Integer> recipes = GlowstoneExtractorRecipes.discharge().getPowerList();
