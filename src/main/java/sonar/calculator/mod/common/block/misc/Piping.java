...
public class Piping extends ConnectedBlock implements ISpecialTooltip {
	...
	/*public void addCollisionBoxesToList(World world, BlockPos pos, IBlockState state, AxisAlignedBB axis, List list, Entity entity) { double minX = 0.2625, maxX = 0.7375; double minZ = 0.2625, maxZ = 0.7375; double minY = 0.2625, maxY = 0.7375;
	 * 
	 * if (checkBlockInDirection(world, pos.getX(), pos.getY(), pos.getZ(), EnumFacing.NORTH)) { maxX = 1; } if (checkBlockInDirection(world, pos.getX(), pos.getY(), pos.getZ(), EnumFacing.SOUTH)) { minX = 0; } if (checkBlockInDirection(world, pos.getX(), pos.getY(), pos.getZ(), EnumFacing.EAST)) { maxZ = 1; } if (checkBlockInDirection(world, pos.getX(), pos.getY(), pos.getZ(), EnumFacing.WEST)) { minZ = 0; } if (checkBlockInDirection(world, pos.getX(), pos.getY(), pos.getZ(), EnumFacing.UP)) { maxY = 1; } if (checkBlockInDirection(world, pos.getX(), pos.getY(), pos.getZ(), EnumFacing.DOWN)) { minY = 0; } list.add(axis); list.add(AxisAlignedBB.fromBounds(pos.getX() + minX, pos.getY() + minY, pos.getZ() + minZ, pos.getX() + maxX, pos.getY() + maxY, pos.getZ() + maxZ)); }
	 * 
	 * public AxisAlignedBB getCollisionBoundingBox(World world, BlockPos pos, IBlockState state) { double minX = 0.2625, maxX = 0.7375; double minZ = 0.2625, maxZ = 0.7375; double minY = 0.2625, maxY = 0.7375; if (checkBlockInDirection(world, pos.getX(), pos.getY(), pos.getZ(), EnumFacing.NORTH)) { maxX = 1; } if (checkBlockInDirection(world, pos.getX(), pos.getY(), pos.getZ(), EnumFacing.SOUTH)) { minX = 0; } if (checkBlockInDirection(world, pos.getX(), pos.getY(), pos.getZ(), EnumFacing.EAST)) { maxZ = 1; } if (checkBlockInDirection(world, pos.getX(), pos.getY(), pos.getZ(), EnumFacing.WEST)) { minZ = 0; } if (checkBlockInDirection(world, pos.getX(), pos.getY(), pos.getZ(), EnumFacing.UP)) { maxY = 1; } if (checkBlockInDirection(world, pos.getX(), pos.getY(), pos.getZ(), EnumFacing.DOWN)) { minY = 0; }
	 * 
