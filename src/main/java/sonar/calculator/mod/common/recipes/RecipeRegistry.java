...
public class RecipeRegistry {
	...
	private static void addStandardRecipes() {
		 ...
		 * 
		 * for (int i = 0; i < 6; i++) { if (i != 3 && i != 4 && i != 5) { registerCalculatorRecipe(new ItemStack(Blocks.log, 2, i), new ItemStack(Blocks.log, 1, i + 1), new ItemStack(Blocks.log, 1, i + 1), type); } if (i == 3) { registerCalculatorRecipe(new ItemStack(Blocks.log, 2, i), new ItemStack(Blocks.log2, 1, 0), new ItemStack(Blocks.log2, 1, 0), type); } else if (i == 4) { registerCalculatorRecipe(new ItemStack(Blocks.log2, 2, 0), new ItemStack(Blocks.log2, 1, 1), new ItemStack(Blocks.log2, 1, 1), type); } else if (i == 5) { registerCalculatorRecipe(new ItemStack(Blocks.log2, 2, 1), new ItemStack(Blocks.log, 1, 0), new ItemStack(Blocks.log, 1, 0), type); } } registerCalculatorRecipe(new ItemStack(Blocks.log, 2, 0), new ItemStack(Blocks.log, 1, 2), new ItemStack(Blocks.log, 1, 3), type); registerCalculatorRecipe(new ItemStack(Blocks.log, 2, 1), new ItemStack(Blocks.log, 1, 2), new ItemStack(Blocks.log, 1, 3), type); registerCalculatorRecipe(new ItemStack(Blocks.log, 2, 1), new ItemStack(Blocks.log2, 1, 1), new ItemStack(Blocks.log, 1, 3), type); registerCalculatorRecipe(new ItemStack(Blocks.log, 2, 1), new ItemStack(Blocks.log2, 1, 1), new ItemStack(Blocks.log, 1, 2), type); registerCalculatorRecipe(new ItemStack(Blocks.log, 2, 0), new ItemStack(Blocks.log, 1, 2), new ItemStack(Blocks.log, 1, 1), type); registerCalculatorRecipe(new ItemStack(Blocks.log, 2, 0), new ItemStack(Blocks.log2, 1, 1), new ItemStack(Blocks.log, 1, 1), type); registerCalculatorRecipe(new ItemStack(Blocks.log, 2, 2), new ItemStack(Blocks.log, 1, 0), new ItemStack(Blocks.log, 1, 3), type); registerCalculatorRecipe(new ItemStack(Blocks.log, 2, 2), new ItemStack(Blocks.log2, 1, 0), new ItemStack(Blocks.log, 1, 3), type); registerCalculatorRecipe(new ItemStack(Blocks.log, 2, 2), new ItemStack(Blocks.log2, 1, 0), new ItemStack(Blocks.log2, 1, 1), type); registerCalculatorRecipe(new ItemStack(Blocks.log, 2, 3), new ItemStack(Blocks.log, 1, 0), new ItemStack(Blocks.log, 1, 1), type);
		 * registerCalculatorRecipe(new ItemStack(Blocks.log, 2, 3), new ItemStack(Blocks.log2, 1, 0), new ItemStack(Blocks.log, 1, 1), type); registerCalculatorRecipe(new ItemStack(Blocks.log, 2, 3), new ItemStack(Blocks.log2, 1, 0), new ItemStack(Blocks.log, 1, 0), type); registerCalculatorRecipe(new ItemStack(Blocks.log2, 2, 0), new ItemStack(Blocks.log, 1, 2), new ItemStack(Blocks.log2, 1, 0), type); registerCalculatorRecipe(new ItemStack(Blocks.log2, 2, 0), new ItemStack(Blocks.log, 1, 2), new ItemStack(Blocks.log, 1, 0), type); registerCalculatorRecipe(new ItemStack(Blocks.log2, 2, 1), new ItemStack(Blocks.log, 1, 1), new ItemStack(Blocks.log, 1, 3), type); registerCalculatorRecipe(new ItemStack(Blocks.log2, 2, 1), new ItemStack(Blocks.log2, 1, 1), new ItemStack(Blocks.log, 1, 0), type);
		 * 
		 * // special log recipes
		 * 
		 ...
		 * 
		 * for (int i = 0; i < 6; i++) { if (i != 5) { registerCalculatorRecipe(new ItemStack(Blocks.planks, 2, i), new ItemStack(Blocks.planks, 1, i + 1), new ItemStack(Blocks.planks, 1, i + 1), type); } else { registerCalculatorRecipe(new ItemStack(Blocks.planks, 2, i), new ItemStack(Blocks.planks, 1, 0), new ItemStack(Blocks.planks, 1, 0), type); } } registerCalculatorRecipe(new ItemStack(Blocks.planks, 2, 0), new ItemStack(Blocks.planks, 1, 2), new ItemStack(Blocks.planks, 1, 1), type); registerCalculatorRecipe(new ItemStack(Blocks.planks, 2, 0), new ItemStack(Blocks.planks, 1, 5), new ItemStack(Blocks.planks, 1, 1), type); registerCalculatorRecipe(new ItemStack(Blocks.planks, 2, 1), new ItemStack(Blocks.planks, 1, 2), new ItemStack(Blocks.planks, 1, 3), type); registerCalculatorRecipe(new ItemStack(Blocks.planks, 2, 1), new ItemStack(Blocks.planks, 1, 5), new ItemStack(Blocks.planks, 1, 3), type); registerCalculatorRecipe(new ItemStack(Blocks.planks, 2, 3), new ItemStack(Blocks.planks, 1, 4), new ItemStack(Blocks.planks, 1, 0), type); registerCalculatorRecipe(new ItemStack(Blocks.planks, 2, 1), new ItemStack(Blocks.planks, 1, 5), new ItemStack(Blocks.planks, 1, 2), type); registerCalculatorRecipe(new ItemStack(Blocks.planks, 2, 2), new ItemStack(Blocks.planks, 1, 0), new ItemStack(Blocks.planks, 1, 3), type); registerCalculatorRecipe(new ItemStack(Blocks.planks, 2, 2), new ItemStack(Blocks.planks, 1, 4), new ItemStack(Blocks.planks, 1, 3), type); registerCalculatorRecipe(new ItemStack(Blocks.planks, 2, 2), new ItemStack(Blocks.planks, 1, 4), new ItemStack(Blocks.planks, 1, 5), type); registerCalculatorRecipe(new ItemStack(Blocks.planks, 2, 3), new ItemStack(Blocks.planks, 1, 0), new ItemStack(Blocks.planks, 1, 1), type); registerCalculatorRecipe(new ItemStack(Blocks.planks, 2, 3), new ItemStack(Blocks.planks, 1, 4), new ItemStack(Blocks.planks, 1, 1), type); registerCalculatorRecipe(new ItemStack(Blocks.planks, 2, 4), new ItemStack(Blocks.planks, 1, 2), new
		 * ItemStack(Blocks.planks, 1, 4), type); registerCalculatorRecipe(new ItemStack(Blocks.planks, 2, 4), new ItemStack(Blocks.planks, 1, 2), new ItemStack(Blocks.planks, 1, 0), type); registerCalculatorRecipe(new ItemStack(Blocks.planks, 2, 5), new ItemStack(Blocks.planks, 1, 1), new ItemStack(Blocks.planks, 1, 3), type); registerCalculatorRecipe(new ItemStack(Blocks.planks, 2, 5), new ItemStack(Blocks.planks, 1, 5), new ItemStack(Blocks.planks, 1), type); registerCalculatorRecipe(new ItemStack(Blocks.planks, 2, 5), new ItemStack(Blocks.planks, 1), type); /* for (int i = 0; i < 6; i++) { if (i != 5) { registerCalculatorRecipe(new ItemStack(Blocks.wooden_slab, 2, i), new ItemStack(Blocks.wooden_slab, 1, i + 1), new ItemStack(Blocks.wooden_slab, 1, i + 1), true); } else { registerCalculatorRecipe(new ItemStack(Blocks.wooden_slab, 2, i), new ItemStack(Blocks.wooden_slab, 1, 0), new ItemStack(Blocks.wooden_slab, 1, 0), true); } }
		 * 
		...
		// saplings
		/* type = RecipeType.SAPLING; for (int i = 0; i < 6; i++) { if (i != 5) { registerCalculatorRecipe(new ItemStack(Blocks.sapling, 2, i), new ItemStack(Blocks.sapling, 1, i + 1), new ItemStack(Blocks.sapling, 1, i + 1), type); } else { registerCalculatorRecipe(new ItemStack(Blocks.sapling, 2, i), new ItemStack(Blocks.sapling, 1, 0), new ItemStack(Blocks.sapling, 1, 0), type); } } registerCalculatorRecipe(new ItemStack(Blocks.sapling, 2, 0), new ItemStack(Blocks.sapling, 1, 2), new ItemStack(Blocks.sapling, 1, 1), type); registerCalculatorRecipe(new ItemStack(Blocks.sapling, 2, 0), new ItemStack(Blocks.sapling, 1, 5), new ItemStack(Blocks.sapling, 1, 1), type); registerCalculatorRecipe(new ItemStack(Blocks.sapling, 2, 1), new ItemStack(Blocks.sapling, 1, 2), new ItemStack(Blocks.sapling, 1, 3), type); registerCalculatorRecipe(new ItemStack(Blocks.sapling, 2, 1), new ItemStack(Blocks.sapling, 1, 5), new ItemStack(Blocks.sapling, 1, 3), type); registerCalculatorRecipe(new ItemStack(Blocks.sapling, 2, 3), new ItemStack(Blocks.sapling, 1, 4), new ItemStack(Blocks.sapling, 1), type); registerCalculatorRecipe(new ItemStack(Blocks.sapling, 2, 1), new ItemStack(Blocks.sapling, 1, 5), new ItemStack(Blocks.sapling, 1, 2), type); registerCalculatorRecipe(new ItemStack(Blocks.sapling, 2, 2), new ItemStack(Blocks.sapling, 1, 0), new ItemStack(Blocks.sapling, 1, 3), type); registerCalculatorRecipe(new ItemStack(Blocks.sapling, 2, 2), new ItemStack(Blocks.sapling, 1, 4), new ItemStack(Blocks.sapling, 1, 3), type); registerCalculatorRecipe(new ItemStack(Blocks.sapling, 2, 2), new ItemStack(Blocks.sapling, 1, 4), new ItemStack(Blocks.sapling, 1, 5), type); registerCalculatorRecipe(new ItemStack(Blocks.sapling, 2, 3), new ItemStack(Blocks.sapling, 1, 0), new ItemStack(Blocks.sapling, 1, 1), type); registerCalculatorRecipe(new ItemStack(Blocks.sapling, 2, 3), new ItemStack(Blocks.sapling, 1, 4), new ItemStack(Blocks.sapling, 1, 1), type); registerCalculatorRecipe(new
		 * ItemStack(Blocks.sapling, 2, 4), new ItemStack(Blocks.sapling, 1, 2), new ItemStack(Blocks.sapling, 1, 4), type); registerCalculatorRecipe(new ItemStack(Blocks.sapling, 2, 4), new ItemStack(Blocks.sapling, 1, 2), new ItemStack(Blocks.sapling, 1), type); registerCalculatorRecipe(new ItemStack(Blocks.sapling, 2, 5), new ItemStack(Blocks.sapling, 1, 1), new ItemStack(Blocks.sapling, 1, 3), type); registerCalculatorRecipe(new ItemStack(Blocks.sapling, 2, 5), new ItemStack(Blocks.sapling, 1, 5), new ItemStack(Blocks.sapling, 1), type); registerCalculatorRecipe(new ItemStack(Blocks.sapling, 1, 0), new ItemStack(Blocks.log, 1, 0), new ItemStack(Blocks.leaves, 1, 0), type); registerCalculatorRecipe(new ItemStack(Blocks.sapling, 1, 1), new ItemStack(Blocks.log, 1, 1), new ItemStack(Blocks.leaves, 1, 1), type); registerCalculatorRecipe(new ItemStack(Blocks.sapling, 1, 2), new ItemStack(Blocks.log, 1, 2), new ItemStack(Blocks.leaves, 1, 2), type); registerCalculatorRecipe(new ItemStack(Blocks.sapling, 1, 3), new ItemStack(Blocks.log, 1, 3), new ItemStack(Blocks.leaves, 1, 3), type); registerCalculatorRecipe(new ItemStack(Blocks.sapling, 1, 4), new ItemStack(Blocks.log2, 1, 0), new ItemStack(Blocks.leaves2, 1, 0), type); registerCalculatorRecipe(new ItemStack(Blocks.sapling, 1, 5), new ItemStack(Blocks.log2, 1, 1), new ItemStack(Blocks.leaves2, 1, 1), type);
		 * 
		 ...
		 * 
		 * registerCalculatorRecipe(new ItemStack(Blocks.leaves, 2, 0), new ItemStack(Blocks.leaves, 1, 2), new ItemStack(Blocks.leaves, 1, 1), type); registerCalculatorRecipe(new ItemStack(Blocks.leaves, 2, 0), new ItemStack(Blocks.leaves2, 1, 1), new ItemStack(Blocks.leaves, 1, 1), type); registerCalculatorRecipe(new ItemStack(Blocks.leaves, 2, 1), new ItemStack(Blocks.leaves, 1, 2), new ItemStack(Blocks.leaves, 1, 3), type); registerCalculatorRecipe(new ItemStack(Blocks.leaves, 2, 1), new ItemStack(Blocks.leaves2, 1, 1), new ItemStack(Blocks.leaves, 1, 3), type); registerCalculatorRecipe(new ItemStack(Blocks.leaves, 2, 1), new ItemStack(Blocks.leaves2, 1, 1), new ItemStack(Blocks.leaves, 1, 2), type); registerCalculatorRecipe(new ItemStack(Blocks.leaves, 2, 2), new ItemStack(Blocks.leaves, 1), new ItemStack(Blocks.leaves, 1, 3), type); registerCalculatorRecipe(new ItemStack(Blocks.leaves, 2, 2), new ItemStack(Blocks.leaves2, 1), new ItemStack(Blocks.leaves, 1, 3), type); registerCalculatorRecipe(new ItemStack(Blocks.leaves, 2, 2), new ItemStack(Blocks.leaves2, 1), new ItemStack(Blocks.leaves2, 1, 1), type); registerCalculatorRecipe(new ItemStack(Blocks.leaves, 2, 3), new ItemStack(Blocks.leaves, 1), new ItemStack(Blocks.leaves, 1, 1), type); registerCalculatorRecipe(new ItemStack(Blocks.leaves, 2, 3), new ItemStack(Blocks.leaves2), new ItemStack(Blocks.leaves, 1, 1), type); registerCalculatorRecipe(new ItemStack(Blocks.leaves, 2, 3), new ItemStack(Blocks.leaves2), new ItemStack(Blocks.leaves, 1), type); registerCalculatorRecipe(new ItemStack(Blocks.leaves2, 2), new ItemStack(Blocks.leaves, 1, 2), new ItemStack(Blocks.leaves2, 1), type); registerCalculatorRecipe(new ItemStack(Blocks.leaves2, 2), new ItemStack(Blocks.leaves, 1, 2), new ItemStack(Blocks.leaves, 1), type); registerCalculatorRecipe(new ItemStack(Blocks.leaves2, 2), new ItemStack(Blocks.leaves, 1, 2), type); registerCalculatorRecipe(new ItemStack(Blocks.leaves2, 2, 1), new ItemStack(Blocks.leaves, 1,
		 * 1), new ItemStack(Blocks.leaves, 1, 3), type); registerCalculatorRecipe(new ItemStack(Blocks.leaves2, 2, 1), new ItemStack(Blocks.leaves2, 1, 1), new ItemStack(Blocks.leaves, 1), type); registerCalculatorRecipe(new ItemStack(Blocks.leaves2, 2, 1), new ItemStack(Blocks.leaves, 1), type); registerCalculatorRecipe(new ItemStack(Blocks.leaves, 4, 0), Blocks.vine, new ItemStack(Blocks.leaves, 1, 0), type); registerCalculatorRecipe(new ItemStack(Blocks.leaves, 4, 1), Blocks.vine, new ItemStack(Blocks.leaves, 1, 1), type); registerCalculatorRecipe(new ItemStack(Blocks.leaves, 4, 2), Blocks.vine, new ItemStack(Blocks.leaves, 1, 2), type); registerCalculatorRecipe(new ItemStack(Blocks.leaves, 4, 3), Blocks.vine, new ItemStack(Blocks.leaves, 1, 3), type); registerCalculatorRecipe(new ItemStack(Blocks.leaves2, 4, 0), Blocks.vine, new ItemStack(Blocks.leaves2, 1, 0), type); registerCalculatorRecipe(new ItemStack(Blocks.leaves2, 4, 1), Blocks.vine, new ItemStack(Blocks.leaves2, 1, 1), type); registerCalculatorRecipe(Items.bed, "treeLeaves", new ItemStack(Blocks.planks, 1), type);
		 * 
		 * //
		 * 
		 * for (int i = 0; i < 9; i++) { switch (i) { case 8: registerCalculatorRecipe(new ItemStack(Blocks.red_flower, 2, i), new ItemStack(Blocks.red_flower, 1, 0), new ItemStack(Blocks.red_flower, 1, 0), RecipeType.FLOWER); break; default: registerCalculatorRecipe(new ItemStack(Blocks.red_flower, 2, i), new ItemStack(Blocks.red_flower, 1, i + 1), new ItemStack(Blocks.red_flower, 1, i + 1), RecipeType.FLOWER); break; } } for (int i = 0; i < 16; i++) { switch (i) { case 15: registerCalculatorRecipe(new ItemStack(Items.dye, 2, i), new ItemStack(Items.dye, 1, 0), new ItemStack(Items.dye, 1, 0), RecipeType.DYE); registerCalculatorRecipe(new ItemStack(Blocks.carpet, 2, i), new ItemStack(Blocks.carpet, 1, 0), new ItemStack(Blocks.carpet, 1, 0), RecipeType.CARPET); registerCalculatorRecipe(new ItemStack(Blocks.stained_hardened_clay, 2, i), new ItemStack(Blocks.stained_hardened_clay, 1, 0), new ItemStack(Blocks.stained_hardened_clay, 1, 0), RecipeType.CLAY_BLOCK); registerCalculatorRecipe(new ItemStack(Blocks.stained_glass_pane, 2, i), new ItemStack(Blocks.stained_glass_pane, 1, 0), new ItemStack(Blocks.stained_glass_pane, 1, 0), RecipeType.GLASS_PANE); registerCalculatorRecipe(new ItemStack(Blocks.stained_glass, 2, i), new ItemStack(Blocks.stained_glass, 1, 0), new ItemStack(Blocks.stained_glass, 1, 0), RecipeType.GLASS); registerCalculatorRecipe(new ItemStack(Blocks.wool, 2, i), new ItemStack(Blocks.wool, 1, 0), new ItemStack(Blocks.wool, 1, 0), RecipeType.WOOL); break; default: registerCalculatorRecipe(new ItemStack(Items.dye, 2, i), new ItemStack(Items.dye, 1, i + 1), new ItemStack(Items.dye, 1, i + 1), RecipeType.DYE); registerCalculatorRecipe(new ItemStack(Blocks.carpet, 2, i), new ItemStack(Blocks.carpet, 1, i + 1), new ItemStack(Blocks.carpet, 1, i + 1), RecipeType.CARPET); registerCalculatorRecipe(new ItemStack(Blocks.stained_hardened_clay, 2, i), new ItemStack(Blocks.stained_hardened_clay, 1, i + 1), new ItemStack(Blocks.stained_hardened_clay, 1, i + 1),
		 * RecipeType.CLAY_BLOCK); registerCalculatorRecipe(new ItemStack(Blocks.stained_glass_pane, 2, i), new ItemStack(Blocks.stained_glass_pane, 1, i + 1), new ItemStack(Blocks.stained_glass_pane, 1, i + 1), RecipeType.GLASS_PANE); registerCalculatorRecipe(new ItemStack(Blocks.stained_glass, 2, i), new ItemStack(Blocks.stained_glass, 1, i + 1), new ItemStack(Blocks.stained_glass, 1, i + 1), RecipeType.GLASS); registerCalculatorRecipe(new ItemStack(Blocks.wool, 2, i), new ItemStack(Blocks.wool, 1, i + 1), new ItemStack(Blocks.wool, 1, i + 1), RecipeType.WOOL);
		 * 
	...
	public static class CalculatorRecipes extends DefinedRecipeHelper {
		...
		public void addRecipes() {
			for (int i = 0; i < RecipeRegistry.unblocked.size(); i++) {
				addRecipe(RecipeRegistry.unblocked.get(i));
			}
		}
	...
	public static class ScientificRecipes extends DefinedRecipeHelper {
	...
	public static class AtomicRecipes extends DefinedRecipeHelper {

		private static final AtomicRecipes recipes = new AtomicRecipes();

		public static final AtomicRecipes instance() {
			return recipes;
		}
	...
	public static class FlawlessRecipes extends DefinedRecipeHelper {

		private static final FlawlessRecipes recipes = new FlawlessRecipes();

		public static final FlawlessRecipes instance() {
			return recipes;
		}
	...
	public static class ConductorMastRecipes extends ValueHelperV2 {
