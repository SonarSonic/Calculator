...
public class InfoUsageHandler extends TemplateRecipeHandler {
	...
	public void loadTransferRects() {
		...
		this.transferRects.add(new TemplateRecipeHandler.RecipeTransferRect(
				new Rectangle(7, 2, 72, 12), "All", new Object[0]));
		this.transferRects.add(new TemplateRecipeHandler.RecipeTransferRect(
				new Rectangle(7, 20, 72, 12), "Blocks", new Object[0]));
		this.transferRects.add(new TemplateRecipeHandler.RecipeTransferRect(
				new Rectangle(7, 38, 72, 12), "Calculators", new Object[0]));
		this.transferRects.add(new TemplateRecipeHandler.RecipeTransferRect(
				new Rectangle(7, 56, 72, 12), "Machines", new Object[0]));
		this.transferRects.add(new TemplateRecipeHandler.RecipeTransferRect(
				new Rectangle(98, 2, 72, 12), "Generators", new Object[0]));
		this.transferRects.add(new TemplateRecipeHandler.RecipeTransferRect(
				new Rectangle(98, 20, 72, 12), "Modules", new Object[0]));
		this.transferRects.add(new TemplateRecipeHandler.RecipeTransferRect(
				new Rectangle(98, 38, 72, 12), "Items", new Object[0]));
		this.transferRects.add(new TemplateRecipeHandler.RecipeTransferRect(
				new Rectangle(98, 56, 72, 12), "Circuits", new Object[0]));
	}
	...
	public void loadUsageRecipes(ItemStack ingredient) {
		...
		for (Map.Entry<ItemStack, String> recipe : recipes.entrySet()) {
			if (NEIServerUtils.areStacksSameTypeCrafting(
				...
				InfoPair arecipe = new InfoPair(ingredient,
						recipe.getValue());
	...
	public void loadCraftingRecipes(String outputId, Object... results) {
		if ((outputId.equals("Machines"))
				&& (getClass() == InfoUsageHandler.class)) {
		...
		} else if ((outputId.equals("Calculators"))
				&& (getClass() == InfoUsageHandler.class)) {
			...
			for (Map.Entry<ItemStack, String> recipe2 : recipes2.entrySet())
				if (InfoList.info().getType(recipe2.getKey()) == "Calculators") {
					this.arecipes.add(new InfoPair(
							recipe2.getKey(), recipe2.getValue()));
					this.transferRects.clear();
				}
				} else if ((outputId.equals("Items"))
						&& (getClass() == InfoUsageHandler.class)) {
					Map<ItemStack, String> recipes3 = InfoList.info()
							.getInfoList();
					for (Map.Entry<ItemStack, String> recipe3 : recipes3
							.entrySet())
						if (InfoList.info().getType(recipe3.getKey()) == "Items") {
							this.arecipes.add(new InfoPair(recipe3
									.getKey(), recipe3.getValue()));
							this.transferRects.clear();
						}
				} else if ((outputId.equals("Generators"))
						&& (getClass() == InfoUsageHandler.class)) {
					Map<ItemStack, String> recipes4 = InfoList.info()
							.getInfoList();
					for (Map.Entry<ItemStack, String> recipe4 : recipes4
							.entrySet())
						if (InfoList.info().getType(recipe4.getKey()) == "Generators") {
							this.arecipes.add(new InfoPair(recipe4
									.getKey(), recipe4.getValue()));
							this.transferRects.clear();
						}
				} else if ((outputId.equals("Circuits"))
						&& (getClass() == InfoUsageHandler.class)) {
					Map<ItemStack, String> recipes5 = InfoList.info()
							.getInfoList();
					for (Map.Entry<ItemStack, String> recipe5 : recipes5
							.entrySet())
						if (InfoList.info().getType(recipe5.getKey()) == "Circuits") {
							this.arecipes.add(new InfoPair(recipe5
									.getKey(), recipe5.getValue()));
							this.transferRects.clear();
						}
				} else if ((outputId.equals("Modules"))
						&& (getClass() == InfoUsageHandler.class)) {
					Map<ItemStack, String> recipes5 = InfoList.info()
							.getInfoList();
					for (Map.Entry<ItemStack, String> recipe6 : recipes5
							.entrySet())
						if (InfoList.info().getType(recipe6.getKey()) == "Modules") {
							this.arecipes.add(new InfoPair(recipe6
									.getKey(), recipe6.getValue()));
							this.transferRects.clear();
						}
				} else if ((outputId.equals("Blocks"))
						&& (getClass() == InfoUsageHandler.class)) {
					Map<ItemStack, String> recipes5 = InfoList.info()
							.getInfoList();
					for (Map.Entry<ItemStack, String> recipe7 : recipes5
							.entrySet())
						if (InfoList.info().getType(recipe7.getKey()) == "Blocks") {
							this.arecipes.add(new InfoPair(recipe7
									.getKey(), recipe7.getValue()));
							this.transferRects.clear();
						}
				} 
			
				else if ((outputId.equals("All"))
						&& (getClass() == InfoUsageHandler.class)) {
					Map<ItemStack, String> recipes5 = InfoList.info()
							.getInfoList();
					for (Map.Entry<ItemStack, String> recipe7 : recipes5
	...
	public void loadCraftingRecipes(ItemStack result) {
		...
		for (Map.Entry<ItemStack, String> recipe : recipes.entrySet()) {
			if (InfoList.info().getInfo(result) == recipe.getValue())
				this.arecipes.add(new InfoPair(recipe.getKey(),
						recipe.getValue()));
