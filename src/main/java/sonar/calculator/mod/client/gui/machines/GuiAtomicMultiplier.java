...
public class GuiAtomicMultiplier extends GuiSonarTile {
	...
	public void drawGuiContainerForegroundLayer(int x, int y) {
		...
		FontHelper.textCentre(FontHelper.formatStorage(entity.storage.getEnergyLevel()), this.xSize, 66, 2);
	...
	protected void drawGuiContainerBackgroundLayer(float var1, int var2, int var3) {
		...
		int energy_level = (int)((double)this.entity.storage.getEnergyLevel() * 128D / (double)this.entity.storage.getFullCapacity());
