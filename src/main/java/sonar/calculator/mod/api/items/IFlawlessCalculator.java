...
public interface IFlawlessCalculator extends IModuleProvider {
     ...
     */
    ItemStack removeModule(ItemStack stack, int slot);
     ...
     */
    void addModule(ItemStack stack, NBTTagCompound moduleTag, IModule module, int slot);
     ...
     */
    boolean canRemoveModule(ItemStack stack, int slot);
     ...
     */
    boolean canAddModule(ItemStack stack, IModule module, int slot);
     ...
     */
    NBTTagCompound getModuleTag(ItemStack stack, int slot);
	 ...
	 * @param stack the Flawless Calculator
     */
    IModule getCurrentModule(ItemStack stack);
	 ...
	 * @param stack the Flawless Calculator
     */
    int getCurrentSlot(ItemStack stack);
}
