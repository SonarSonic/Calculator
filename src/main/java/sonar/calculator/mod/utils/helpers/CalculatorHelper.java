...
public class CalculatorHelper {
	 ...
	 * @param list Tool Tip
	 */
    public static void addEnergytoToolTip(ItemStack stack, EntityPlayer player, List<String> list) {
	 ...
	 * @param list Tool Tip
	 */
    public static void addItemLevelToolTip(ItemStack stack, EntityPlayer player, List<String> list) {
	 ...
	 * @param list Tool Tip
	 */
    public static void addGasToolTip(ItemStack stack, EntityPlayer player, List<String> list) {
        if (stack.hasTagCompound()) {
