...
public class InfoList {
	...
	private InfoList() {
		...
		addRecipe("Machines", new ItemStack(Calculator.stoneSeparator), "A basic seperator-+Used for making Amethyst-+Runs on RF");
		addRecipe("Machines", new ItemStack(Calculator.algorithmSeparator), "A basic seperator-+Used for making Tanzanite-+Runs on RF");
		...
		addRecipe("Calculators", new ItemStack(Calculator.atomicCalculator), "Adds three items together-Doesn't require RF or EU");
		...
		addRecipe("Machines", new ItemStack(Calculator.CO2Generator), "Burns fuels to create CO2-Used with Flawless Greenhouse-See Controlled Fuel");
